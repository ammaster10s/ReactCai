      ...
      <div className="bg-white-A700 flex flex-col font-lexend items-center justify-start mx-auto w-full">
        <div className="flex flex-col items-center justify-start w-full">
          <Img
            ...
            alt="groupOne"
          />
          <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between max-w-[1256px] mt-[109px] mx-auto md:px-5 w-full">
            <Img
              className="h-[414px] md:h-auto md:mt-0 mt-[71px] object-cover"
              src="images/img_image12714541280.png"
              alt="image1271454128"
            />
            <div className="bg-gray-50 flex flex-col items-center justify-start p-8 sm:px-5 rounded-[91px] shadow-bs1">
              <div className="flex flex-col gap-[18px] justify-start mb-[83px] w-[82%] md:w-full">
                ...
                <div className="flex flex-col items-start justify-start mr-[59px]">
                  ...
                  <Text
                    className="mt-[84px] text-3xl sm:text-[26px] md:text-[28px] text-teal-700"
                    size="txtLexendBold30"
                  >
                    สาเหตุการเสียหาย :
                  </Text>
                  <Text
                    className="mt-[83px] text-3xl sm:text-[26px] md:text-[28px] text-black-900"
                    size="txtLexendBold30Black900"
                  >
                    ท่านควรติดต่อ
                  </Text>
                  <Text
                    className="mt-20 text-3xl sm:text-[26px] md:text-[28px] text-black-900"
                    size="txtLexendBold30Black900"
                  >
          ...
          <div className="h-[135px] mt-[65px] md:px-5 relative w-full">
